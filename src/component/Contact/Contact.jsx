...
export default function Contact() {
  return (
    <>
   <div className="bg-[#bcbcbc] w-full h-96 flex items-center justify-start ">
  <div className="text-left mb-8 ml-8">
    <div className="flex items-center space-x-3">
      <FaHome className="text-white w-8 h-8 hover:text-yellow-600" />
      <h2 className="text-white text-3xl font-bold hover:text-yellow-600">Contact Us</h2>
    </div>
  </div>
</div>
